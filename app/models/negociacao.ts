export class Negociacao { // usa-se o export para exportar esta classe

    constructor( // no construtor basicamente, sao os valores que obrigatoriamente a classe tera que receber como parâmetro
        private _data: Date, // o readonly faz a leitura e dessa forma, dispensa o uso do metodo get para realizar a leitura. O único caso que será valido é no volume
